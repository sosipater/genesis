...
class AppDatabase {
  ...
  static Future<String> _resolveDbPath(String databasesPath) async {
    final String current = p.join(databasesPath, "genesis_mobile.db");
    final String legacy = p.join(databasesPath, "recipe_forge_mobile.db");
  ...
  Future<Database> get database async {
    ...
    final String dbPath = await _resolveDbPath(databasesPath);
